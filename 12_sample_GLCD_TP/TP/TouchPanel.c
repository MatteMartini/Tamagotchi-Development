...
* Attention		 : None
*******************************************************************************/
void DrawCross(uint16_t Xpos,uint16_t Ypos)  //SFRUTTA ANCHE LIBRERIA LCD!
{
...
void TouchPanel_Calibrate(void)
{
  ...
  {     
   //#ifndef SIMULATOR
	 DelayUS(1000 * 500); //microsecondi //è tanto, pero devi farlo per forza se no non aspetta abbastanza tempo per calibrare lo schermo con la scheda vera! MA CON L'EMULATORE è TROPPO!! METTI SOLO 1000
	 //DelayUS(1000);
		//#endif	
