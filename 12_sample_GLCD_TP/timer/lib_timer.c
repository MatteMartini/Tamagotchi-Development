...
//*** <<< end of configuration section >>>    ***
  ...
  else if ( timer_num == 1 )  //animazione e batteria
  {
	LPC_TIM1->MR0 = TimerInterval;
	LPC_TIM1->MCR = 3;				/* Interrupt and Reset on MR1 */  //per tutti e 2 i timer vogliamo reset+interrupt, anche il RIT
	...
	else if ( timer_num == 2 )  //touch
  {
	LPC_TIM2->MR0 = TimerInterval;
	LPC_TIM2->MCR = 3;				/* Interrupt and Reset on MR1 */  //per tutti e 2 i timer vogliamo reset+interrupt, anche il RIT
	...
	else if ( timer_num == 3 )  //note
  {
	LPC_TIM3->MR0 = TimerInterval;
	LPC_TIM3->MCR = 3;				/* Interrupt and Reset on MR1 */  //per tutti e 2 i timer vogliamo reset+interrupt, anche il RIT
